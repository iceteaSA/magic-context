...
| `memory.external.search` | boolean | `true` | Expose the ctx_search 'external' source (project + main bank). (default: true) |
...
| `dreamer.tasks.distill-skill-memory.schedule` **Live** | string | `""` | 5-field cron schedule (e.g. "0 3 \* \* \*"), or "" to disable this task. |
