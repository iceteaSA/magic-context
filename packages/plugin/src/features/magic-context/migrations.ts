...
export const MIGRATIONS: Migration[] = [
    ...
    {
        // Skill-memory P1: per-skill cross-session recall. Originally v38, then
        // v39/v42/v54/v70 across earlier rebases; renumbered up the chain; now v73
        // after upstream v0.33.1 shipped its own v70-v72.
        version: 73,
    ...
    {
        // Skill-memory P2: was v39/v43/v55/v71 across earlier rebases; renumbered
        // across upstream migrations — now v74 after upstream v0.33.1 took
        // v70-v72 (skill-P1 is v73, skill-P2 v74, skill-P3a v75).
        version: 74,
        description:
            "Skill-memory P2: delta_embedding + recall_count columns + skill_memory_fts FTS5 vtable",
        up: (db: Database) => {
            // skill_memory is migration-only (created by v73); ALTER is safe here.
    ...
    },
    {
        ...
        // Renumbered across many upstream rebases (v31→33→37→38→39→42→50→73); now
        // v76 in the union, where upstream holds v54-v72 and skill-memory holds
        // v73/74/75 (skill migrations precede external by convention). The body is
        // ensureColumn-idempotent, so a dev DB that already ran it under an old
        // number re-applies harmlessly.
        version: 76,
