...
Generated by `packages/plugin/scripts/export-agent-surface.ts` at 2026-08-09.
Token counts are Claude BPE estimates on the raw text.

## 1. System-prompt guidance section

### PRIMARY full (reduce=on, memory=on, dreamer=on, temporal=on) — 9833 chars, ~2294 tokens
...
### PRIMARY memory-off (reduce=on, memory=off) — 8767 chars, ~2027 tokens
...
### PRIMARY reduce-off (reduce=off, memory=on) — 7548 chars, ~1768 tokens
...
|---|---:|---|
| PRIMARY full | 9903 | `364016b6f55a1b2a03e8f05d9172d8f3` |
| PRIMARY memory-off | 8829 | `a5397c5e0131bef9d05e25762a841c9b` |
| PRIMARY reduce-off | 7596 | `e49a4e90ec39d6585f27bd0cdb54889b` |
