...
Generated by `packages/plugin/scripts/export-agent-surface.ts` at 2026-09-14.
Token counts are Claude BPE estimates on the raw text.

## 1. System-prompt guidance section

### PRIMARY full (reduce=on, memory=on, dreamer=on, temporal=on) — 9871 chars, ~2299 tokens
...
### PRIMARY memory-off (reduce=on, memory=off) — 8805 chars, ~2032 tokens
...
### PRIMARY reduce-off (reduce=off, memory=on) — 7603 chars, ~1780 tokens
...
### ctx_memory — description ~278 tokens, params ~306 tokens (total ~584)
...
### ctx_search — description ~455 tokens, params ~200 tokens (total ~655)

**Description:**

```
Your long-term recall for this project — search local history plus explicitly requested external long-term knowledge, not just what's currently visible.
...
|---|---:|---|
| PRIMARY full | 9941 | `7061a763119c8fb8986070ca928826c3` |
| PRIMARY memory-off | 8867 | `e3ac7fc6f03f044829abfbd14d7878fc` |
| PRIMARY reduce-off | 7651 | `1c3cc3e7235a0c8d7ead28e2bd16896c` |
