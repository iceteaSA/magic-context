...
For each pass, you emit up to five things:
...
5. **Skill observations** *(optional)* — universal reusable lessons about skills the agent actually used, fed to the skill-memory pipeline.
