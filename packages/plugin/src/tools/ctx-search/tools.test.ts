...
describe("createCtxSearchTools", () => {
    ...
    it("formats empty search results", async () => {
        ...
        expect(result).toBe(
            'No results found for "missing" across notes, memories, primers, git commits, message history, or external knowledge.',
        );
    });
    ...
    it("child session resolves to the parent's history via the parent registry", async () => {
